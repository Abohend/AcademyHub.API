...
namespace AcademyHub.Application.Interfaces
{
    public interface IStudentService
    {
        ...
        Task<PaginatedResult<List<StudentResponse>>> GetAllStudentsAsync(int page, int pageSize, string? name, int? age);
    ...
    public interface IClassService
    {
        ...
        Task<PaginatedResult<List<ClassResponse>>> GetAllClassesAsync(int page, int pageSize, string? name, string? teacher);
        Task<Result> DeleteClassAsync(Guid id);
        Task<Result<AverageMarksResponse>> GetAverageMarksAsync(Guid classId);
        Task<PaginatedResult<List<TopStudentResponse>>> GetTopStudentsAsync(GetTopStudentRequest request);
    }
